...
Update of this version: optimize the library for constructing multiple graphs over subsets of vectors. Replace all arrays with std::vectors to better support dynamic insertions.
